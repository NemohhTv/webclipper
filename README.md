...
Open http://localhost:8000. Add a source (path to a folder with video files), then reload recordings.
...
Open http://localhost:8000. In Settings, add a source with the **container** path (e.g. `/mnt/recordings/Elgato`), then use Recordings to browse and edit.
